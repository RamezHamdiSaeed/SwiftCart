...
class CollectionViewDesign{
    ...
    static func collectionView (colView:UICollectionView){
        ...
        colView.layer.borderColor = UIColor(red: 255.0/255.0, green: 192.0/255.0, blue: 203.0/255.0, alpha: 1.0).cgColor
    ...
    static func collectionViewCell (cell: UICollectionViewCell){
        ...
        cell.contentView.layer.borderColor = UIColor(red: 255.0/255.0, green: 192.0/255.0, blue: 203.0/255.0, alpha: 1.0).cgColor
